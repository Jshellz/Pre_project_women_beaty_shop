...
<div class="main-wrapper">
    ...
    <main class="content">
        ...
        <section class="promo-video">
            ...
            <img class="promo-video__decor js-img" data-src="##" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="">
        </section>
        <!-- PROMO VIDEO EOF   -->
        <!-- BEGIN DISCOUNT -->
        <div class="discount discount-about js-img" data-src="##">
            <div class="wrapper">
        ...
        <div class="insta-photos">
            <a href="#" class="insta-photo">
                <img data-src="##" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" class="js-img"
                     alt="">
        ...
        <div class="header-content">
            ...
            <div class="header-box">
                ...
                <ul class="header-options">
                    ...
                    <li><a href="#"><i class="icon-cart"></i><span>0</span></a></li>
                </ul>
            </div>
